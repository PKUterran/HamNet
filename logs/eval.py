...
tag_path = (
    ...
    ['tox21 no pos', ['TOX21/lipop_nopos@{}.json'.format(seed) for seed in SEEDS[:1]], True],
    ['tox21 pos', ['TOX21/tox21_pos@{}.json'.format(seed) for seed in SEEDS[:1]], True],
    ['lipop no pos', ['Lipop/lipop_nopos@{}.json'.format(seed) for seed in SEEDS[:1]], False],
    ['lipop pos', ['Lipop/lipop_pos@{}.json'.format(seed) for seed in SEEDS[:1]], False],
