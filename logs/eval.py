...
tag_path = (
    ...
    # ['tox21 no pos', ['TOX21/tox21_nopos@{}.json'.format(seed) for seed in SEEDS[:2]], True],
    # ['tox21 pos', ['TOX21/tox21_pos@{}.json'.format(seed) for seed in SEEDS[:2]], True],
    # ['tox21 rdpos', ['TOX21/tox21_rdpos@{}.json'.format(seed) for seed in SEEDS[:2]], True],
